...
public class sphereModular {
    ...
    public static double userInput() { // 1. Input & Radius (r)
    ...
    public static double surfaceArea(double r) { // 2. Surface Area (s)
        double s = 4.0 * PI * Math.pow(r, 2);
        return s;
    }

    public static double volume(double r) { // 3. Volume (v)
